  ...
  function InternalTreeNode() {
    ...
    _this.renderNodeAdder = function () {
      ...
      return /*#__PURE__*/React.createElement("div", {
        className: (0, _classnames.default)(data.childClass, "".concat(prefixCls, "-treenode")),
        style: style
      }, /*#__PURE__*/React.createElement("span", {
        className: (0, _classnames.default)(wrapClass, "".concat(wrapClass, "-normal"))
      }, data.childIcon && /*#__PURE__*/React.createElement("span", {
        className: (0, _classnames.default)("".concat(prefixCls, "-iconEle"), "".concat(prefixCls, "-icon__child"), "".concat(prefixCls, "-icon__customize"))
